...
const WEAPONS = [
    ...
    { id: 'mp153', image: 'mp153.png', imageFolder: 'Weapons', name: 'MP-153', nameEn: 'MP-153', category: 'shotgun', rarity: 'collection', rarityName: 'Коллекционное', rarityNameEn: 'Collection', damage: 84, rpm: 265, headshotMult: 1.25, effectiveRange: 95.0, fireModes: ['auto', 'single'], ammoTypes: ['12x70_shot', '12x70_buckshot', '12x76_dart', '12x76_slug'], stats: { verticalRecoil: 4.68, horizontalRecoil: 2.57, hipSpread: 0.89, adsSpread: 0.89 } },
    ...
    { id: 'fn_p90', image: 'fn_p90.png', imageFolder: 'Weapons', name: 'FN P90', nameEn: 'FN P90', category: 'smg', rarity: 'rare', rarityName: 'Раритетное', rarityNameEn: 'Rare', damage: 24, rpm: 1100, headshotMult: 1.25, effectiveRange: 51.0, fireModes: ['auto', 'single'], ammoTypes: ['9x19_ps', '9x19_pp', '9x19_dum'], stats: { verticalRecoil: 0.32, horizontalRecoil: 0.51, hipSpread: 0.37, adsSpread: 0.37 } },
    ...
    { id: 'ppsh41', image: 'ppsh41.png', imageFolder: 'Weapons', name: 'ППШ-41', nameEn: 'PPSh-41', category: 'smg', rarity: 'uncommon', rarityName: 'Необычное', rarityNameEn: 'Uncommon', damage: 30, rpm: 1000, headshotMult: 1.25, effectiveRange: 80.0, fireModes: ['auto', 'single'], ammoTypes: ['9x19_ps', '9x19_pp', '9x19_dum'], stats: { verticalRecoil: 1.8, horizontalRecoil: 1.18, hipSpread: 0.62, adsSpread: 0.62 } },
    ...
    { id: 'akm', image: 'akm.png', imageFolder: 'Weapons', name: 'АКМ', nameEn: 'AKM', category: 'assault', rarity: 'uncommon', rarityName: 'Необычное', rarityNameEn: 'Uncommon', damage: 37, rpm: 600, headshotMult: 1.25, effectiveRange: 110.0, fireModes: ['auto', 'single'], ammoTypes: ['762x39_ps', '762x39_bp'], stats: { verticalRecoil: 3.11, horizontalRecoil: 1.22, hipSpread: 0.68, adsSpread: 0.30 } },
    ...
    { id: 'hk_g3a3', image: 'hk_g3a3.png', imageFolder: 'Weapons', name: 'HK G3A3', nameEn: 'HK G3A3', category: 'assault', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 46, rpm: 585, headshotMult: 1.25, effectiveRange: 132.0, fireModes: ['auto', 'single'], ammoTypes: ['762x51_m59', '762x51_m61'], stats: { verticalRecoil: 3.1, horizontalRecoil: 0.95, hipSpread: 0.88, adsSpread: 0.16 } },
    { id: 'steyr_aug_a3', image: 'steyr_aug_a3.png', imageFolder: 'Weapons', name: 'Steyr AUG A3', nameEn: 'Steyr AUG A3', category: 'assault', rarity: 'collection', rarityName: 'Коллекционное', rarityNameEn: 'Collection', damage: 32, rpm: 725, headshotMult: 1.25, effectiveRange: 112.0, fireModes: ['auto', 'single'], ammoTypes: ['556x45_m855', '556x45_m995', '556x45_hp'], stats: { verticalRecoil: 1.39, horizontalRecoil: 0.73, hipSpread: 0.49, adsSpread: 0.20 } },
    ...
    { id: 'fn_fnc', image: 'fn_fnc.png', imageFolder: 'Weapons', name: 'FN FNC', nameEn: 'FN FNC', category: 'assault', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 38, rpm: 700, headshotMult: 1.25, effectiveRange: 145.0, fireModes: ['auto', 'single'], ammoTypes: ['556x45_m855', '556x45_m995', '556x45_hp'], stats: { verticalRecoil: 1.64, horizontalRecoil: 0.54, hipSpread: 0.48, adsSpread: 0.14 } },
    { id: 'fn_f2000_tactical', image: 'fn_f2000_tactical.png', imageFolder: 'Weapons', name: 'FN F2000 Tactical', nameEn: 'FN F2000 Tactical', category: 'assault', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 33.50, rpm: 850, headshotMult: 1.25, effectiveRange: 140.0, fireModes: ['auto', 'single'], ammoTypes: ['556x45_m855', '556x45_m995', '556x45_hp'], stats: { verticalRecoil: 1.27, horizontalRecoil: 0.49, hipSpread: 0.46, adsSpread: 0.18 } },
    ...
    { id: 'ak12', image: 'ak12.png', imageFolder: 'Weapons', name: 'АК-12', nameEn: 'AK-12', category: 'assault', rarity: 'rare', rarityName: 'Раритетное', rarityNameEn: 'Rare', damage: 34, rpm: 740, headshotMult: 1.25, effectiveRange: 110.0, fireModes: ['auto', 'single'], ammoTypes: ['545x39_ps', '545x39_bp', '545x39_snp', '545x39_bs'], stats: { verticalRecoil: 1.69, horizontalRecoil: 0.49, hipSpread: 0.53, adsSpread: 0.17 } },
    { id: 'hk_xm8', image: 'hk_xm8.png', imageFolder: 'Weapons', name: 'HK XM8', nameEn: 'HK XM8', category: 'assault', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 35, rpm: 800, headshotMult: 1.25, effectiveRange: 120.0, fireModes: ['auto', 'single'], ammoTypes: ['556x45_m855', '556x45_m995', '556x45_hp'], stats: { verticalRecoil: 1.38, horizontalRecoil: 0.35, hipSpread: 0.54, adsSpread: 0.18 } },
    ...
    { id: 'hk417', image: 'hk417.png', imageFolder: 'Weapons', name: 'HK417', nameEn: 'HK417', category: 'assault', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 45, rpm: 575, headshotMult: 1.25, effectiveRange: 140.0, fireModes: ['auto', 'single'], ammoTypes: ['762x51_m59', '762x51_m61'], stats: { verticalRecoil: 2.55, horizontalRecoil: 0.76, hipSpread: 0.60, adsSpread: 0.05 } },
    { id: 'galil_ace_51', image: 'galil_ace_51.png', imageFolder: 'Weapons', name: 'Galil ACE 51', nameEn: 'Galil ACE 51', category: 'assault', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 41, rpm: 685, headshotMult: 1.25, effectiveRange: 90.0, fireModes: ['auto', 'single'], ammoTypes: ['762x51_m59', '762x51_m61'], stats: { verticalRecoil: 2.61, horizontalRecoil: 0.99, hipSpread: 0.48, adsSpread: 0.15 } },
    ...
    // SNIPER RIFLES
    { id: 'remington_700', image: 'remington_700.png', imageFolder: 'Weapons', name: 'Remington 700', nameEn: 'Remington 700', category: 'sniper', rarity: 'collection', rarityName: 'Коллекционное', rarityNameEn: 'Collection', damage: 140, rpm: 30, headshotMult: 1.50, effectiveRange: 105.0, fireModes: ['single'], ammoTypes: ['308_winchester'], stats: { verticalRecoil: 3.00, horizontalRecoil: 2.15, hipSpread: 2.00, adsSpread: 0.08 } },
    { id: 'svd', image: 'svd.png', imageFolder: 'Weapons', name: 'Снайперская винтовка Драгунова', nameEn: 'SVD Dragunov', category: 'sniper', rarity: 'collection', rarityName: 'Коллекционное', rarityNameEn: 'Collection', damage: 115, rpm: 111, headshotMult: 1.25, effectiveRange: 210.0, fireModes: ['single'], ammoTypes: ['762x54_lps', '762x54_bs', '762x54_hp'], stats: { verticalRecoil: 3.20, horizontalRecoil: 2.40, hipSpread: 5.00, adsSpread: 0.11 } },
    { id: 'vsk94', image: 'vsk94.png', imageFolder: 'Weapons', name: 'ВСК-94', nameEn: 'VSK-94', category: 'sniper', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 38.5, rpm: 725, headshotMult: 1.35, effectiveRange: 85.0, fireModes: ['auto', 'single'], ammoTypes: ['9x39_sp5', '9x39_sp6'], stats: { verticalRecoil: 1.52, horizontalRecoil: 0.3, hipSpread: 5.00, adsSpread: 0.10 } },
    ...
    { id: 'walther_wa2000', image: 'walther_wa2000.png', imageFolder: 'Weapons', name: 'Walther WA 2000', nameEn: 'Walther WA 2000', category: 'sniper', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 139, rpm: 111, headshotMult: 1.35, effectiveRange: 240.0, fireModes: ['single'], ammoTypes: ['308_winchester'], stats: { verticalRecoil: 5.00, horizontalRecoil: 1.50, hipSpread: 5.00, adsSpread: 0.05, moveSpeed: -3.00 } },
    { id: 'sv98', image: 'sv98.png', imageFolder: 'Weapons', name: 'СВ-98', nameEn: 'SV-98', category: 'sniper', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 183, rpm: 33, headshotMult: 1.50, effectiveRange: 270.0, fireModes: ['single'], ammoTypes: ['762x54_lps', '762x54_bs', '762x54_hp'], stats: { verticalRecoil: 3.55, horizontalRecoil: 3.10, hipSpread: 2.00, adsSpread: 0.03, moveSpeed: -3.00 } },
    { id: 'sako_trg42', image: 'sako_trg42.png', imageFolder: 'Weapons', name: 'Sako TRG-42', nameEn: 'Sako TRG-42', category: 'sniper', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 185, rpm: 25, headshotMult: 1.50, effectiveRange: 290.0, fireModes: ['single'], ammoTypes: ['308_winchester'], stats: { verticalRecoil: 4.00, horizontalRecoil: 3.50, hipSpread: 5.00, adsSpread: 0.05, moveSpeed: -3.00 } },
    { id: 'barrett_m82', image: 'barrett_m82.png', imageFolder: 'Weapons', name: 'Barrett M82', nameEn: 'Barrett M82', category: 'sniper', rarity: 'legendary', rarityName: 'Легендарное', rarityNameEn: 'Legendary', damage: 195, rpm: 111, headshotMult: 1.35, effectiveRange: 280.0, fireModes: ['single'], ammoTypes: ['127x55'], stats: { verticalRecoil: 12.50, horizontalRecoil: 11.00, hipSpread: 10.00, adsSpread: 0.07, moveSpeed: -10.00, mutantDamageMultiplier: 2.5 } },
    { id: 'm24', image: 'm24.png', imageFolder: 'Weapons', name: 'Снайперская винтовка М24', nameEn: 'M24 Sniper Rifle', category: 'sniper', rarity: 'rare', rarityName: 'Раритетное', rarityNameEn: 'Rare', damage: 158, rpm: 35, headshotMult: 1.50, effectiveRange: 135.0, fireModes: ['single'], ammoTypes: ['308_winchester'], stats: { verticalRecoil: 2.75, horizontalRecoil: 1.80, hipSpread: 2.00, adsSpread: 0.05 } },
    { id: 'mosin_obrez', image: 'mosin_obrez.png', imageFolder: 'Weapons', name: 'Обрез винтовки Мосина', nameEn: 'Mosin Obrez', category: 'sniper', damage: 122, rpm: 20, headshotMult: 1.50, effectiveRange: 81.0, fireModes: ['single'], ammoTypes: ['762x54_lps', '762x54_bs', '762x54_hp'], stats: { verticalRecoil: 3.65, horizontalRecoil: 2.20, hipSpread: 2.00, adsSpread: 0.19 } },
    ...
    { id: 'l96a1', image: 'l96a1.png', imageFolder: 'Weapons', name: 'L96A1', nameEn: 'L96A1', category: 'sniper', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 180, rpm: 30, headshotMult: 1.50, effectiveRange: 300.0, fireModes: ['single'], ammoTypes: ['308_winchester'], stats: { verticalRecoil: 2.10, horizontalRecoil: 1.00, hipSpread: 2.00, adsSpread: 0.03, moveSpeed: -3.00 } },
    ...
    { id: 'svds', image: 'svds.png', imageFolder: 'Weapons', name: 'СВД-С', nameEn: 'SVDS', category: 'sniper', rarity: 'rare', rarityName: 'Раритетное', rarityNameEn: 'Rare', damage: 125, rpm: 120, headshotMult: 1.35, effectiveRange: 228.0, fireModes: ['single'], ammoTypes: ['762x54_lps', '762x54_bs', '762x54_hp'], stats: { verticalRecoil: 2.75, horizontalRecoil: 1.20, hipSpread: 5.00, adsSpread: 0.09 } },
    { id: 'mk14_ebr', image: 'mk14_ebr.png', imageFolder: 'Weapons', name: 'Mk14 Enhanced Battle Rifle', nameEn: 'Mk14 EBR', category: 'sniper', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 54, rpm: 500, headshotMult: 1.35, effectiveRange: 190.0, fireModes: ['auto', 'single'], ammoTypes: ['762x51_m59', '762x51_m61'], stats: { verticalRecoil: 4.05, horizontalRecoil: 1.07, hipSpread: 0.77, adsSpread: 0.05 } },
    { id: 'sr25', image: 'sr25.png', imageFolder: 'Weapons', name: 'SR-25', nameEn: 'SR-25', category: 'sniper', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 85, rpm: 215, headshotMult: 1.50, effectiveRange: 130.0, fireModes: ['single'], ammoTypes: ['308_winchester'], stats: { verticalRecoil: 2.52, horizontalRecoil: 0.55, hipSpread: 5.00, adsSpread: 0.10 } },
    { id: 'sks', image: 'sks.png', imageFolder: 'Weapons', name: 'СКС', nameEn: 'SKS', category: 'sniper', rarity: 'uncommon', rarityName: 'Необычное', rarityNameEn: 'Uncommon', damage: 45, rpm: 460, headshotMult: 1.35, effectiveRange: 130.0, fireModes: ['single'], ammoTypes: ['762x39_ps', '762x39_bp'], stats: { verticalRecoil: 2.62, horizontalRecoil: 0.85, hipSpread: 1.50, adsSpread: 0.17 } },
    { id: 'vssk_vykhlop', image: 'vssk_vykhlop.png', imageFolder: 'Weapons', name: 'ВССК «Выхлоп»', nameEn: 'VSSK "Vykhlop"', category: 'sniper', rarity: 'legendary', rarityName: 'Легендарное', rarityNameEn: 'Legendary', damage: 220, rpm: 27, headshotMult: 1.50, effectiveRange: 150.0, fireModes: ['single'], ammoTypes: ['127x55'], stats: { verticalRecoil: 10.00, horizontalRecoil: 9.50, hipSpread: 5.00, adsSpread: 0.04, moveSpeed: -4.00 } },
    ...
    { id: 'vss_vintorez', image: 'vss_vintorez.png', imageFolder: 'Weapons', name: 'ВСС «Винторез»', nameEn: 'VSS "Vintorez"', category: 'sniper', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 39, rpm: 700, headshotMult: 1.35, effectiveRange: 80.0, fireModes: ['auto', 'single'], ammoTypes: ['9x39_sp5', '9x39_sp6'], stats: { verticalRecoil: 1.46, horizontalRecoil: 0.31, hipSpread: 5.00, adsSpread: 0.12 } },
    { id: 'ots03_svua', image: 'ots03_svua.png', imageFolder: 'Weapons', name: 'ОЦ-03 СВУ-А', nameEn: 'OTs-03 SVU-A', category: 'sniper', rarity: 'rare', rarityName: 'Раритетное', rarityNameEn: 'Rare', damage: 70, rpm: 221, headshotMult: 1.35, effectiveRange: 180.0, fireModes: ['auto'], ammoTypes: ['762x54_lps', '762x54_bs', '762x54_hp'], stats: { verticalRecoil: 1.50, horizontalRecoil: 0.93, hipSpread: 5.00, adsSpread: 0.12 } },
    { id: 'hk_g3sg1', image: 'hk_g3sg1.png', imageFolder: 'Weapons', name: 'HK G3SG-1', nameEn: 'HK G3SG-1', category: 'sniper', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 57, rpm: 380, headshotMult: 1.35, effectiveRange: 200.0, fireModes: ['auto', 'single'], ammoTypes: ['762x51_m59', '762x51_m61'], stats: { verticalRecoil: 1.98, horizontalRecoil: 0.45, hipSpread: 5.00, adsSpread: 0.10 } },
    ...
    // PISTOLS
    { id: 'pm', image: 'pm.png', imageFolder: 'Weapons', name: 'Пистолет Макарова', nameEn: 'Makarov PM', category: 'pistol', damage: 30, rpm: 250, headshotMult: 2.00, effectiveRange: 45.0, fireModes: ['single'], ammoTypes: ['9x18_p', '9x18_bjt', '9x18_pp'], stats: { verticalRecoil: 1.87, horizontalRecoil: 1.50, hipSpread: 0.55, adsSpread: 0.55, moveSpeed: 2.00 } },
    { id: 'pb', image: 'pb.png', imageFolder: 'Weapons', name: 'Пистолет Бесшумный (ПБ)', nameEn: 'PB Silenced Pistol', category: 'pistol', damage: 29, rpm: 250, headshotMult: 2.00, effectiveRange: 36.0, fireModes: ['single'], ammoTypes: ['9x18_p', '9x18_bjt', '9x18_pp'], stats: { verticalRecoil: 1.82, horizontalRecoil: 1.39, hipSpread: 0.55, adsSpread: 0.55, moveSpeed: 2.00 } },
    ...
    { id: 'glock18', image: 'glock18.png', imageFolder: 'Weapons', name: 'Glock 18', nameEn: 'Glock 18', category: 'pistol', rarity: 'collection', rarityName: 'Коллекционное', rarityNameEn: 'Collection', damage: 27, rpm: 800, headshotMult: 1.75, effectiveRange: 45.0, fireModes: ['auto', 'single'], ammoTypes: ['9x19_ps', '9x19_pp', '9x19_dum'], stats: { verticalRecoil: 1.43, horizontalRecoil: 0.67, hipSpread: 0.52, adsSpread: 0.52, moveSpeed: 2.00 } },
    { id: 'colt_1911', image: 'colt_1911.png', imageFolder: 'Weapons', name: 'Colt 1911', nameEn: 'Colt 1911', category: 'pistol', rarity: 'collection', rarityName: 'Коллекционное', rarityNameEn: 'Collection', damage: 39, rpm: 265, headshotMult: 2.50, effectiveRange: 54.0, fireModes: ['single'], ammoTypes: ['45acp', '45acp_super', '45acp_hydra'], stats: { verticalRecoil: 2.00, horizontalRecoil: 1.50, hipSpread: 0.39, adsSpread: 0.39, moveSpeed: 2.00 } },
    { id: 'gsh18', image: 'gsh18.png', imageFolder: 'Weapons', name: 'ГШ-18', nameEn: 'GSh-18', category: 'pistol', rarity: 'collection', rarityName: 'Коллекционное', rarityNameEn: 'Collection', damage: 35, rpm: 365, headshotMult: 2.00, effectiveRange: 51.0, fireModes: ['single'], ammoTypes: ['9x19_ps', '9x19_pp', '9x19_dum'], stats: { verticalRecoil: 1.62, horizontalRecoil: 1.15, hipSpread: 0.48, adsSpread: 0.48, moveSpeed: 2.00 } },
    ...
    { id: 'aps', image: 'aps.png', imageFolder: 'Weapons', name: 'АПС', nameEn: 'APS Stechkin', category: 'pistol', rarity: 'rare', rarityName: 'Раритетное', rarityNameEn: 'Rare', damage: 32, rpm: 750, headshotMult: 1.75, effectiveRange: 36.0, fireModes: ['auto', 'single'], ammoTypes: ['9x18_p', '9x18_bjt', '9x18_pp'], stats: { verticalRecoil: 1.92, horizontalRecoil: 0.80, hipSpread: 0.45, adsSpread: 0.45, moveSpeed: 2.00 } },
    { id: 'aps-Kramora', image: 'aps-Kramora.png', imageFolder: 'Weapons', name: 'АПС Крамора', nameEn: 'APS "Kramora"', category: 'pistol', rarity: 'rare', rarityName: 'Раритетное', rarityNameEn: 'Rare', damage: 32, rpm: 750, headshotMult: 1.75, effectiveRange: 36.0, fireModes: ['auto', 'single'], ammoTypes: ['9x18_p', '9x18_bjt', '9x18_pp'], stats: { verticalRecoil: 1.96, horizontalRecoil: 0.82, hipSpread: 0.48, adsSpread: 0.48, moveSpeed: 2.00 } },
    { id: 'sig_p220', image: 'sig_p220.png', imageFolder: 'Weapons', name: 'SIG Sauer P220', nameEn: 'SIG Sauer P220', category: 'pistol', rarity: 'rare', rarityName: 'Раритетное', rarityNameEn: 'Rare', damage: 36, rpm: 290, headshotMult: 2.00, effectiveRange: 54.0, fireModes: ['single'], ammoTypes: ['45acp', '45acp_super', '45acp_hydra'], stats: { verticalRecoil: 1.78, horizontalRecoil: 1.25, hipSpread: 0.40, adsSpread: 0.40, moveSpeed: 2.00 } },
    { id: 'alpine', image: 'alpine.png', imageFolder: 'Weapons', name: '«Альпиец»', nameEn: '"Alpine"', category: 'pistol', rarity: 'rare', rarityName: 'Раритетное', rarityNameEn: 'Rare', damage: 36, rpm: 290, headshotMult: 2.00, effectiveRange: 54.0, fireModes: ['single'], ammoTypes: ['45acp', '45acp_super', '45acp_hydra'], stats: { verticalRecoil: 1.78, horizontalRecoil: 1.25, hipSpread: 0.40, adsSpread: 0.40, moveSpeed: 2.00 } },
    { id: 'desert_eagle', image: 'desert_eagle.png', imageFolder: 'Weapons', name: 'Desert Eagle Mark XIX', nameEn: 'Desert Eagle Mark XIX', category: 'pistol', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 52, rpm: 250, headshotMult: 2.50, effectiveRange: 63.0, fireModes: ['single'], ammoTypes: ['45acp', '45acp_super', '45acp_hydra'], stats: { verticalRecoil: 2.88, horizontalRecoil: 2.40, hipSpread: 0.39, adsSpread: 0.39, moveSpeed: 2.00 } },
    { id: 'black-hawk', image: 'black-hawk.png', imageFolder: 'Weapons', name: 'Черный ястреб', nameEn: 'Black Hawk', category: 'pistol', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 50, rpm: 267, headshotMult: 2.50, effectiveRange: 45.0, fireModes: ['single'], ammoTypes: ['9x39_sp5', '9x39_sp6'], stats: { verticalRecoil: 2.75, horizontalRecoil: 2.20, hipSpread: 0.46, adsSpread: 0.46, moveSpeed: 2.00 } },
    { id: 'big-jackpot', image: 'big-jackpot.png', imageFolder: 'Weapons', name: 'Большой куш', nameEn: 'Big Jackpot', category: 'pistol', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 60, rpm: 325, headshotMult: 2.50, effectiveRange: 69.0, fireModes: ['auto', 'single'], ammoTypes: ['45acp', '45acp_super', '45acp_hydra'], stats: { verticalRecoil: 2.30, horizontalRecoil: 0.80, hipSpread: 0.15, adsSpread: 0.15, moveSpeed: 2.00 } },
    // MACHINE GUNS
    { id: 'rpk74', image: 'rpk74.png', imageFolder: 'Weapons', name: 'РПК-74', nameEn: 'RPK-74', category: 'machinegun', rarity: 'collection', rarityName: 'Коллекционное', rarityNameEn: 'Collection', damage: 36, rpm: 650, headshotMult: 1.25, effectiveRange: 124.0, fireModes: ['auto', 'single'], ammoTypes: ['545x39_ps', '545x39_bp', '545x39_snp'], stats: { verticalRecoil: 2.55, horizontalRecoil: 0.71, hipSpread: 0.45, adsSpread: 0.17, moveSpeed: -4.00 } },
    { id: 'rpd', image: 'rpd.png', imageFolder: 'Weapons', name: 'РПД', nameEn: 'RPD', category: 'machinegun', rarity: 'collection', rarityName: 'Коллекционное', rarityNameEn: 'Collection', damage: 37, rpm: 700, headshotMult: 1.25, effectiveRange: 118.0, fireModes: ['auto', 'single'], ammoTypes: ['762x39_ps', '762x39_bp'], stats: { verticalRecoil: 2.90, horizontalRecoil: 0.81, hipSpread: 0.65, adsSpread: 0.27, moveSpeed: -5.00 } },
    { id: 'm249_saw', image: 'm249_saw.png', imageFolder: 'Weapons', name: 'M249 SAW', nameEn: 'M249 SAW', category: 'machinegun', rarity: 'rare', rarityName: 'Раритетное', rarityNameEn: 'Rare', damage: 32, rpm: 800, headshotMult: 1.25, effectiveRange: 120.0, fireModes: ['auto'], ammoTypes: ['556x45_m855', '556x45_m995', '556x45_hp'], stats: { verticalRecoil: 2.35, horizontalRecoil: 0.62, hipSpread: 0.70, adsSpread: 0.19, moveSpeed: -3.00 } },
    { id: 'm60', image: 'm60.png', imageFolder: 'Weapons', name: 'M60', nameEn: 'M60', category: 'machinegun', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 48, rpm: 585, headshotMult: 1.25, effectiveRange: 124.0, fireModes: ['auto', 'single'], ammoTypes: ['762x51_m59', '762x51_m61'], stats: { verticalRecoil: 3.50, horizontalRecoil: 1.18, hipSpread: 0.65, adsSpread: 0.15, moveSpeed: -6.00 } },
    { id: 'pkm', image: 'pkm.png', imageFolder: 'Weapons', name: 'ПКМ', nameEn: 'PKM', category: 'machinegun', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 44, rpm: 650, headshotMult: 1.25, effectiveRange: 120.0, fireModes: ['auto'], ammoTypes: ['762x54_pp'], stats: { verticalRecoil: 3.45, horizontalRecoil: 1.29, hipSpread: 0.85, adsSpread: 0.20, moveSpeed: -6.00 } },
    { id: 'pkp_pecheneg', image: 'pkp_pecheneg.png', imageFolder: 'Weapons', name: 'ПКП «Печенег»', nameEn: 'PKP "Pecheneg"', category: 'machinegun', rarity: 'unique', rarityName: 'Уникальное', rarityNameEn: 'Unique', damage: 44, rpm: 650, headshotMult: 1.25, effectiveRange: 126.0, fireModes: ['auto'], ammoTypes: ['762x54_pp'], stats: { verticalRecoil: 3.12, horizontalRecoil: 1.05, hipSpread: 0.69, adsSpread: 0.16, moveSpeed: -5.00 } },
    // SHOTGUNS (additional)
    { id: 'toz34_obrez', image: 'toz34_obrez.png', imageFolder: 'Weapons', name: 'Обрез ТОЗ-34', nameEn: 'TOZ-34 Obrez', category: 'shotgun', damage: 77, rpm: 1000, headshotMult: 1.25, effectiveRange: 72.0, fireModes: ['single', 'auto'], ammoTypes: ['12x70_shot', '12x70_buckshot', '12x76_dart', '12x76_slug'], stats: { verticalRecoil: 6.25, horizontalRecoil: 4.75, hipSpread: 1.18, adsSpread: 1.18 } },
    { id: 'toz34', image: 'toz34.png', imageFolder: 'Weapons', name: 'Охотничье ружьё ТОЗ-34', nameEn: 'TOZ-34 Hunting Rifle', category: 'shotgun', damage: 81, rpm: 1000, headshotMult: 1.25, effectiveRange: 96.0, fireModes: ['single', 'auto'], ammoTypes: ['12x70_shot', '12x70_buckshot', '12x76_dart', '12x76_slug'], stats: { verticalRecoil: 6.14, horizontalRecoil: 4.64, hipSpread: 1.06, adsSpread: 1.06 } },
    { id: 'toz66_obrez', image: 'toz66_obrez.png', imageFolder: 'Weapons', name: 'Обрез ТОЗ-66', nameEn: 'TOZ-66 Obrez', category: 'shotgun', damage: 80, rpm: 1000, headshotMult: 1.25, effectiveRange: 72.0, fireModes: ['single', 'auto'], ammoTypes: ['12x70_shot', '12x70_buckshot', '12x76_dart', '12x76_slug'], stats: { verticalRecoil: 6.00, horizontalRecoil: 5.00, hipSpread: 1.30, adsSpread: 1.30 } },
